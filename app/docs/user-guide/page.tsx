  ...
  return (
    <section className='space-y-8'>
      ...
      <p className='text-lg leading-relaxed text-foreground'>
        Follow these steps to get the most out of AIPenGuild. From connecting your wallet, to minting AI NFTs, to
        staking them for XP, we’ve got you covered.
      </p>
      ...
      <div className='flex flex-col gap-6 md:flex-row'>
        <div className='space-y-3 md:w-1/2'>
          ...
          <p className='text-base leading-relaxed text-foreground'>
            We support EVM-compatible wallets and Polkadot.js-based solutions. Switch your wallet to the correct test
            network (Moonbase Alpha or Westend). Ensure you have enough test tokens (DEV or WND) for gas.
            <br />
      ...
      <div className='flex flex-col gap-6 md:flex-row-reverse'>
        <div className='space-y-3 md:w-1/2'>
          ...
          <p className='text-base leading-relaxed text-foreground'>
            On the <strong>Mint</strong> page, enter your AI prompt, choose a category, and let the model generate your
            NFT image + attributes. Finalize by paying
            <code className='rounded bg-accent/10 px-1'>0.1 {`<NativeToken>`}</code> or <code>100 XP</code>.
          </p>
        </div>
        <div className='flex justify-center md:w-1/2'>
          <Image
      ...
      <div className='flex flex-col gap-6 md:flex-row'>
        <div className='space-y-3 md:w-1/2'>
          ...
          <p className='text-base leading-relaxed text-foreground'>
            ...
            <em> NFTStakingPool</em>. Over time, you earn XP at the <code>xpPerSecond</code> rate. Claim your rewards
            anytime or automatically upon unstaking.
          </p>
        </div>
        <div className='flex justify-center md:w-1/2'>
          <Image
      ...
      <div className='flex flex-col gap-6 md:flex-row-reverse'>
        <div className='space-y-3 md:w-1/2'>
          ...
          <p className='text-base leading-relaxed text-foreground'>
            Access <strong>My NFTs</strong> to list items for sale, update prices, or unlist them. The{' '}
            <strong>Marketplace</strong> tab allows you to browse and buy others’ NFTs. All XP ownership automatically
            updates on purchase or transfer.
          </p>
        </div>
        <div className='flex justify-center md:w-1/2'>
          <Image
      ...
      <div className='rounded-md border border-border bg-secondary p-4 text-secondary-foreground shadow-sm'>
        ...
        <p className='text-base leading-relaxed text-foreground'>
          You’re now ready to explore AIPenGuild fully. If you have any additional questions, check out our{' '}
          <strong>FAQ</strong> or head over to the <strong>Developer APIs</strong>
