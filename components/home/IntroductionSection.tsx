...
export default function IntroductionSection() {
  return (
    <section
      id="introduction"
      className="w-full bg-gradient-to-r from-white to-blue-50 dark:from-gray-900 dark:to-gray-800 px-4 py-12 sm:py-16 md:py-20 lg:py-24"
    >
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 md:flex-row">
        ...
        >
          ...
          <p className="max-w-md text-sm leading-relaxed text-muted-foreground sm:text-base">
            Learn more about AIPenGuild in this short video. Discover
            how our AI-driven NFT platform, staking rewards, and
            gamified XP system create a truly immersive experience.
          </p>
