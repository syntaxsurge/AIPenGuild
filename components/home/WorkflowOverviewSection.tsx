...
export default function WorkflowOverviewSection() {
  ...
  return (
    <section
      ...
      className='relative w-full bg-white px-4 py-12 dark:bg-gray-900 sm:py-16 md:py-20 lg:py-24'
    >
      <div className='mx-auto max-w-6xl'>
        ...
        >
          <h2 className='mb-6 break-words text-3xl font-extrabold text-primary sm:text-4xl md:text-5xl'>
