    ...
    <section className='space-y-8'>
      <div className='flex flex-col-reverse items-center gap-8 md:flex-row'>
        ...
        <div className='md:w-1/2'>
          <h1 className='mb-4 text-4xl font-extrabold text-primary'>
            Welcome to the AIPenGuild Documentation
          </h1>
          <p className='mb-4 text-lg leading-relaxed text-foreground'>
            Experience the power of AI-driven NFT creation and learn how to integrate these robust
            assets into your dApp or game. Whether you are a user trying to mint your first AI NFT
            or a developer exploring cross-chain potential, this is your launchpad.
          </p>
          <p className='mb-4 text-lg leading-relaxed text-foreground'>
            ...
            you’ll discover the best practices for harnessing our REST APIs to fetch NFT data, user
            XP, and more—integrating it seamlessly into your own ecosystem.
          </p>
        </div>
      ...
      <div className='flex flex-col items-center gap-4 md:flex-row md:items-start'>
        <div className='space-y-4 md:w-1/2'>
          ...
          <p className='text-lg leading-relaxed text-foreground'>
            Check out this short overview of AIPenGuild in action. See how NFT creation, staking,
            and the marketplace come together to form a cohesive, AI-driven ecosystem.
          </p>
        </div>
      ...
      <div className='space-y-4 rounded-md border border-border bg-secondary p-4 text-secondary-foreground shadow-sm'>
        ...
        <p className='text-base leading-relaxed text-foreground'>
          Below is a visualization of how the entire system fits together: from AI-based NFT
          creation and IPFS storage, to staking, marketplace features, XP tracking, and cross-chain
          interoperability. This diagram provides a broader look at AIPenGuild's core contracts and
          their interactions.
        </p>
      ...
      <div className='space-y-3'>
        ...
        <ul className='ml-4 list-inside list-decimal space-y-1 text-lg text-foreground'>
          <li>
            <strong>User Guide</strong> – Learn how to connect, mint, stake, and manage NFTs with an
            easy interface.
          </li>
          <li>
            <strong>Developer APIs</strong> – Integrate NFT data, staking stats, and XP queries into
            your own dApp.
          </li>
          <li>
            <strong>FAQ</strong> – Find answers to common questions about the XP system, listing,
            bridging, and more.
          </li>
        </ul>
      </div>
