...
*   **MOONBASE\_RPC\_NETWORK**: RPC endpoint for Moonbase Alpha.
*   **WESTEND\_RPC\_NETWORK**: RPC endpoint for Westend AssetHub.
*   **PRIVATE\_KEY**: Private key of your deployer account (from a wallet or test account).
