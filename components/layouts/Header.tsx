        ...
        >
          <div className='flex flex-col gap-4 px-4 py-4 text-sm uppercase md:flex-row md:items-center md:justify-end md:py-0'>
            ...
            <div className='group relative'>
              ...
              <div className='absolute left-0 top-full hidden min-w-[180px] pt-2 group-hover:block'>
...
export const Logo = () => {
  return (
    <Link href='/' className='flex items-center space-x-2'>
      ...
      <span className='text-lg font-bold text-primary hover:opacity-90 md:text-xl'>AIPenGuild</span>
    </Link>
  )
}
