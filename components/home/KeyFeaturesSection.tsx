        ...
        <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3'>
          ...
          >
            ...
            <p className='break-words text-sm leading-relaxed text-muted-foreground'>
              Harness sophisticated LLM prompts to produce unique NFT attributes, while advanced
              image models craft stunning visuals. Your NFT is stored securely on IPFS, complete
              with robust metadata for cross-game usage.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className='break-words text-sm leading-relaxed text-muted-foreground'>
              Lock up your NFTs to passively accumulate XP at a steady rate. Claim your rewards
              anytime, or let them build for bigger benefits—perfect for gamers aiming to power up
              in upcoming titles or experiences.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className='break-words text-sm leading-relaxed text-muted-foreground'>
              Each NFT carries random XP (1 to 100). Collect more NFTs or stake them to climb the
              ranks, earning prestigious titles like &quot;{XP_TITLES[2].label}&quot;, &quot;
              {XP_TITLES[5].label}&quot;, or &quot;
          ...
          >
            ...
            <p className='break-words text-sm leading-relaxed text-muted-foreground'>
              Seamlessly list, purchase, or trade NFTs in our integrated marketplace. A 10% platform
              fee supports the <em>PlatformRewardPool</em>, fueling rewards and ecosystem growth. XP
              ownership transfers automatically with each sale.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className='break-words text-sm leading-relaxed text-muted-foreground'>
              Operating on networks like Moonbase Alpha and Westend, AIPenGuild ensures your NFTs
              remain portable. Whether bridging to new Polkadot parachains or EVM ecosystems, your
              assets follow you seamlessly.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className='break-words text-sm leading-relaxed text-muted-foreground'>
              ...
              &amp;{' '}
              <code className='rounded-sm bg-accent/10 px-1'>/api/v1/gaming/user/[address]</code>.
              Fetch metadata, XP, stake status, or attributes to power truly interoperable
              experiences.
            </p>
          </motion.div>
        </div>
